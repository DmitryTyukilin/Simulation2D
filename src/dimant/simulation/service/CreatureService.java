...
public class CreatureService {
    ...
    public void triggerActiveCreature(Creature creature, String typeNextMove ) {
       ...
       switch(reaction) {
           case GO -> shiftCreature(creature);
           ...
           default -> eatGrass(creature); // xз чё тут сделать, может остаться на месте
       };
    }

    public void shiftCreature(Creature creature) {
        Coordinate nextCoordinate = navigator.nextCoordinateAboutCurrent(creature);
